...
- **Stemma** (this repo, v1): the catalog plus a static site at [justbost.com/stemma/](https://justbost.com/stemma/) (GitHub Pages). The old `stemma.neworbitdigital.com` (Cloudflare Pages) is being retired to a 301 redirect.
