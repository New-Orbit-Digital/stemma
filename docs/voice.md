...
3. **Mention disagreement once, plainly.** Give it one clause or sentence, such as "Some sources place its origin in…" or "Other accounts describe it as…". Don't adjudicate and don't hedge every clause.
