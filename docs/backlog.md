...
- **R3** — OG Kush family. Scheduled planner run, 2026-09-24 16:45 UTC.
- **R4** — GSC family.
...
- **R6 — Chemotype enrichment (proposed, blocked on STM-U9 merging).** Populate `chemotype` on
  ...
  AllBud, lab-data pages), cited and paraphrased like every other fact.
